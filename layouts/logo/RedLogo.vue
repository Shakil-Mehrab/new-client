<template>
  <svg
    ...
    style="enable-background: new 0 0 184 89.8"
    xml:space="preserve"
  >
    <style type="text/css">
      .red {
    ...
    <path
      class="red"
      d="M62.9,26c0-8-6.5-14.5-14.5-14.5l-37.2,0v11h36.5c2.8,0,4.2,1.3,4.2,3.9v17.3c0,2.6-1.4,3.9-4.2,3.9H22.2V29.6
	h-11v29.1h36.4c4.3,0,7.9-1.4,10.9-4.3c3-2.8,4.5-6.4,4.5-10.7V26z"
    />
    <path
      class="red"
      d="M123.7,44.1c0,8.1,6.5,14.6,14.6,14.6h37v-11h-36.2c-2.9,0-4.4-1.3-4.4-3.9V26.4c0-2.6,1.5-3.9,4.4-3.9h36.2
	v-11l-37.1,0c-8,0-14.5,6.5-14.5,14.5V44.1z"
    />
    <path
      class="red"
      d="M119.2,26.2c0.7-8-6-14.5-14.1-14.5H61.5c3.2,2.8,5.4,6.7,6.2,11l0,0h35.8l0.6,0c2,0,3.6,1.4,3.5,3.4
    ...
    <g>
      <path
        class="red"
        d="M28.1,68.6c0,1.4-0.4,2.5-1.2,3.4c-0.9,1-2,1.5-3.3,1.5h-4.3c-1.2,0-2.1,0.1-2.6,0.4c-0.8,0.4-1.2,1-1.4,2
      ...
      <path
        class="red"
        d="M46.6,76.5H44v3.2h-3.8v-3.2H29.7l0-3.6l9.2-9.2H44v9.1h5.3L46.6,76.5z M40.2,72.7v-5.5l-5.8,5.5H40.2z"
      />
      <path class="red" d="M61.5,63.6l-10,16h-5.1l10.3-16H61.5z" />
      <path
        class="red"
        d="M71.9,79.6h-5.1l8.1-12.3H61l2.3-3.8h18.7L71.9,79.6z"
      />
    </g>
    <path
      class="red"
      d="M86.8,63.7l-4.2,7.2h0l-5.1,8.7h0l0,0.1h97.8v-0.1v-8.7v-0.5v-6.7H86.8z M105.4,77.2h-2.7
